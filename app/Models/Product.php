...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'EAN-13_individual', 'unidades_embalaje_individual', 'dimensions_boxes', 'weight', 'EAN-13_box_1', 'pack_units',
        'unidades_embalaje_2', 'dimensions_boxes_2', 'weight_2', 'EAN-13_box_2',
        'unidades_embalaje_3', 'dimensions_boxes_3', 'weight_3', 'EAN-13_box_3',
