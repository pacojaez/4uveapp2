            ...
            <h2 class="m-4 ml-12 text-xl font-semibold leading-tight text-gray-800">
             ...
             <div class="space-x-8 text-center justify-items-center sm:-my-px sm:ml-10 sm:flex sm:w-full">
                <div class="relative w-1/2">
                    <input type="text" wire:model.debounce.500ms="search" type="search" class="w-full p-2 pl-8 bg-gray-200 border border-gray-200 rounded focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="Buscar Productos..." />
                ...
                <a class="col-span-12 transition duration-300 transform bg-white rounded-lg shadow-xl hover:scale-105 sm:col-span-6 xl:col-span-3 intro-y"
                    ...
                    <div class="p-2">
                        ...
                        <div class="md:flex-shrink-0">
                            <img class="object-cover w-full h-48 md:w-48" src="{{ $product->product_image }}" alt="Man looking at item at a store">
                          </div>
                        <div class="flex-1 w-full ml-2">
                            <div>
                                <div class="mt-3 text-xl font-bold leading-8">Precio Compra: {{$product->invoice_cost_price}} €</div>
