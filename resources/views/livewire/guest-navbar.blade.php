<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex w-full">
                ...
                @if(Auth::user())
                <div class="justify-end flex-grow sm:flex sm:items-center sm:ml-6 place-items-center">
                    <!-- Settings Dropdown -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <!-- BUSCADOR -->
        <div class="flex items-center pt-2 pb-3 space-y-1">
            <input class="max-w-md px-3 mt-2 mb-2 ml-20 text-xl rounded shadow-lg sm:max-w-1/2 h-5/6 focus:outline-none focus:shadow-outline" type="search" placeholder="Buscar Productos...">
            </div>
         <!-- Responsive Settings Options Menu Principal -->
        <div class="pt-4 pb-1 border-gray-200 border-t-1">
