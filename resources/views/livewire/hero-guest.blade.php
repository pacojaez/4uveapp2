    ...
    <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
        ...
        <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div class="hero-text col-span-6">
                <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Vende tu Stock</h1>
                {{-- <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8"> --}}
                <h2 class="text-gray-700 text-2xl leading-relaxed mt-8 font-semibold">al contado</h2>
                <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Y consigue artículos</h1>
                {{-- <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8"> --}}
                <h2 class="text-gray-700 text-3xl leading-relaxed mt-8 font-semibold">que necesitas</h2>
                <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">a precio de ganga</h1>
                {{-- <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8"> --}}
