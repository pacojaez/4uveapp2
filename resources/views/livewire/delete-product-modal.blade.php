<x-modal>
    ...
    <x-slot name="buttons">
        ...
        <button wire:click="$emit('destroyProduct')" class="w-full px-3 py-2 m-2 text-center text-red-400 border-2 border-red-600 rounded-lg cursor-pointer hover:bg-red-600 hover:text-red-200">
