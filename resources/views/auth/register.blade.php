    ...
    {{-- <x-jet-authentication-card> --}}
        ...
        {{-- <section class="flex items-stretch w-full min-h-screen text-white ">
            ...
            <div class="z-0 flex items-center justify-center w-full px-0 text-center lg:w-1/2 md:px-16" style="background-color: #161616;">
                <div class="absolute inset-0 z-10 items-center bg-gray-500 bg-no-repeat bg-cover lg:hidden" style="background-image: url(https://images.unsplash.com/photo-1609618992870-f519a360482e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80);">
...
<div class="container relative items-center max-w-full px-6 mx-auto bg-gray-500 bg-no-repeat bg-cover md:py-24" style="background-image: url(https://images.unsplash.com/photo-1609618992870-f519a360482e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80);">
        ...
        <div class="relative flex flex-wrap">
            ...
            <div class="relative w-full bg-gray-300 bg-opacity-10 rounded-3xl">
                <div class="md:mt-6">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="w-full px-4 mx-auto lg:px-0" x-data="{password: '',password_confirm: ''}">
                    @csrf
                    {{-- <form class="mt-8" x-data="{password: '',password_confirm: ''}"> --}}
                        <div class="max-w-lg mx-auto ">
                            ...
                            {{-- <div class="mt-4">
                                <x-jet-label for="password" value="{{ __('Password') }}" />
                                <x-jet-input x-model="password" id="password" class="block w-full mt-1" type="password" name="password" required autocomplete="current-password" />
                            </div> --}}
                            <div class="mt-4">
                                <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}" />
