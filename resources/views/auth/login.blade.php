            ...
            <div class="z-0 flex items-center justify-center w-full px-0 text-center lg:w-1/2 md:px-16" style="background-color: #161616;">
                ...
                <div class="z-20 py-6">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="w-full px-4 mx-auto lg:px-0">
                        ...
                        <div>
                            <x-jet-label for="email" value="{{ __('Email') }}" />
                            <x-jet-input id="email" class="block w-full mt-1 text-gray-700" type="email" name="email" required autofocus />
                        </div>
                        {{-- <div class="pt-4 pb-2">
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-label for="password" value="{{ __('Password') }}" />
                            <x-jet-input x-model="password" id="password" class="block w-full mt-1 text-gray-700" type="password" name="password" required  />
                        ...
                        {{-- <div class="px-4 pt-4 pb-2">
                            <button class="block w-full p-4 text-lg uppercase bg-indigo-500 rounded-full hover:bg-indigo-600 focus:outline-none">ENTRAR</button>
                        </div>
     --}}
