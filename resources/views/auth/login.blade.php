        ...
        <section class="min-h-screen w-full flex items-stretch text-white ">
            <div class="lg:flex w-2/3 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://images.unsplash.com/photo-1609618992870-f519a360482e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80);">
                ...
                <div class="w-full px-24 z-10">
                    <h1 class="text-5xl font-bold text-left tracking-wide">Vende tu STOCK</h1>
                    <p class="text-3xl my-4">cóbralo al contado</p>
                    <h1 class="text-5xl font-bold text-left tracking-wide">Y consigue los artículos</h1>
                    <p class="text-3xl my-4">que necesitas</p>
                    <h1 class="text-5xl font-bold text-left tracking-wide">a precio de ganga</h1>
            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
                ...
                <div class="py-6 z-20">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="w-full px-4 lg:px-0 mx-auto">
                        @csrf
                        <div>
                            <x-jet-label for="email" value="{{ __('Email') }}" />
                            <x-jet-input id="email" class="block mt-1 w-full text-gray-700" type="email" name="email" required autofocus />
                        </div>
                        {{-- <div class="pb-2 pt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-label for="password" value="{{ __('Password') }}" />
                            <x-jet-input x-model="password" id="password" class="block mt-1 w-full text-gray-700" type="password" name="password" required  />
                        ...
                        <div class="text-right text-gray-400 hover:underline hover:text-gray-100 mt-3">
                        ...
                        {{-- <div class="px-4 pb-2 pt-4">
                            <button class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">ENTRAR</button>
                        </div>
     --}}
