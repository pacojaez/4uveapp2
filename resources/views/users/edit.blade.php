<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ __('Editar Usuario con ID: ')  }}{{ $user->id }}
        </h2>
    </x-slot>
            ...
            <div class="flex flex-col">
                <div id="converters-area" class="px-4 py-5">
                    <div class="flex flex-col text-gray-700">
                        {{-- <form method="POST" action="{{ route('user.update') }}" x-data="{password: '', password_confirm: ''}">
                        @csrf --}}
                        <form action="{{ route('user.update', $user ) }}" method="POST" x-data="{password: '', password_confirm: ''}">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <div>
                                    <x-jet-label for="name" value="{{ __('Nombre') }}" />
                                    <x-jet-input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name')" autofocus placeholder="{{$user->name}}" />
                                </div>
                            ...
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="surname" value="{{ __('Apellidos') }}" />
                                <x-jet-input id="surname" class="block w-full mt-1" type="text" name="surname" :value="old('surname')" autofocus placeholder="{{$user->surname}}" />
                        ...
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="phone" value="{{ __('Teléfono') }}" />
                                <x-jet-input id="phone" class="block w-full mt-1" type="text" name="phone" :value="old('phone')" autofocus placeholder="{{$user->phone}}" />
                            ...
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="email" value="{{ __('Email') }}" />
                                <x-jet-input id="email" class="block w-full mt-1" type="email" name="email" :value="old('email')" autofocus placeholder="{{ $user->email }}" />
                        ...
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}" />
                                <x-jet-input x-model="password_confirmation" id="password_confirmation" class="block w-full mt-1" type="password" name="password_confirmation"  />
                        ...
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="company" value="{{ __('Empresa') }}" />
                                <x-jet-input id="company" class="block w-full mt-1" type="text" name="company" :value="old('company')" autofocus placeholder="{{ $user->company }}"/>
                            ...
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                ...
                                <x-jet-label for="comercial_name" value="{{ __('Nombre Comercial') }}" />
                                <x-jet-input id="comercial_name" class="block w-full mt-1" type="text" name="comercial_name" :value="old('comercial_name')" autofocus placeholder="{{ $user->comercial_name }}"/>
                            </div>
                        </div>
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="CIF" value="{{ __('CIF') }}" />
                                <x-jet-input id="CIF" class="block w-full mt-1" type="text" name="CIF" :value="old('CIF')" autofocus placeholder="{{ $user->CIF }}"/>
                                {{-- <label class="mb-1" for="height-metres">Volume (litres)</label>
                                <input type="number" id="volume-litres" class="px-5 py-3 text-gray-600 rounded focus:outline-none focus:text-gray-600" /> --}}
                            </div>
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                ...
                                <input type="number" id="volume-gallons" class="px-5 py-3 text-gray-600 rounded focus:outline-none focus:text-gray-600" /> --}}
                                <x-jet-label for="adress" value="{{ __('Dirección') }}" />
                                <x-jet-input id="adress" class="block w-full mt-1" type="text" name="adress" :value="old('adress')" autofocus placeholder="{{ $user->adress }}"/>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="city" value="{{ __('Localidad') }}" />
                                <x-jet-input id="city" class="block w-full mt-1" type="text" name="city" :value="old('city')" autofocus placeholder="{{ $user->city }}"/>
                                {{-- <label class="mb-1" for="height-metres">Volume (litres)</label>
                                <input type="number" id="volume-litres" class="px-5 py-3 text-gray-600 rounded focus:outline-none focus:text-gray-600" /> --}}
                            </div>
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                ...
                                <input type="number" id="volume-gallons" class="px-5 py-3 text-gray-600 rounded focus:outline-none focus:text-gray-600" /> --}}
                                <x-jet-label for="cp" value="{{ __('Codigo Postal') }}" />
                                <x-jet-input id="cp" class="block w-full mt-1" type="number" name="cp" :value="old('cp')" pattern="{0-9}" autofocus placeholder="{{ $user->cp }}"/>
                            </div>
                        </div>
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col w-3/6 px-2 text-center">
                                <x-jet-label for="province" value="{{ __('Provincia') }}" />
                                <x-jet-input id="province" class="block w-full mt-1" type="text" max=5 name="province" :value="old('province')" autofocus placeholder="{{ $user->province }}"/>
                                {{-- <label class="mb-1" for="height-metres">Volume (litres)</label>
                                <input type="number" id="volume-litres" class="px-5 py-3 text-gray-600 rounded focus:outline-none focus:text-gray-600" /> --}}
                            </div>
